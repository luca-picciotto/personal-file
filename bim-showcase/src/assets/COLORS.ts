...
export  const backgroundColors = [
    ...
    new THREE.Color().setHex(0x000000), // 52 - Black (Space)
    new THREE.Color().setHex(0x0d0d0d), // 53 - Very Dark Gray (Space)
    new THREE.Color().setHex(0x1a1a1a), // 54 - Dark Gray (Space)
    new THREE.Color().setHex(0x262626), // 55 - Gray (Space)
    new THREE.Color().setHex(0x333333), // 56 - Light Gray (Space)
