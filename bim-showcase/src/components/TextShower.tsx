  ...
  return (
    <div className="text-shower" ref={ref}>
      <p id="tsp-1" ref={tsp1}>
        ...
        <span ref={cRef1}>
          IFC fino a 1GB in alta fedeltà, con prestazioni eccellenti anche da
          mobile e tablet
        </span>
      </p>
      <p id="tsp-2" ref={tsp2}>
        ...
        <span ref={cRef2}>
          Allega documenti ai singoli elementi all'interno del tuo file IFC
        </span>
      </p>
      <p id="tsp-3" ref={tsp3}>
        <span ref={hRef3}>Workspace condiviso</span>
        <span ref={cRef3}>
          Condividi i tuoi modelli versionati con i tuoi clienti e
          collaboratori. Tieni al sicuro i tuoi file garantendo accesso solo a
          chi vuoi.
        </span>
      </p>
      <p id="tsp-4">
